...
class UserTest {
    ...
    fun init(){
        runBlocking {
            ...
            User.create(TEST_USER_NAME_A, TEST_PASSWORD_A, TEST_ROLES)
            User.create(TEST_USER_NAME_B, TEST_PASSWORD_B, TEST_ROLES)
        }
    }
    ...
    fun `create user`(){
        runBlocking {
            val beforeCount = uniAwait(collection.countDocuments())
            val TEST_USER_NAME_C = "test_user_c"
            val TEST_PASSWORD_C = "test_password_c"
            val insertUser = User.create(TEST_USER_NAME_C, TEST_PASSWORD_C, TEST_ROLES)
            val afterCount = uniAwait(collection.countDocuments())
