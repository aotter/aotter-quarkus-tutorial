  ...
  <div class="w-100">
    <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
      <div class="container-fluid">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            <li v-if="isLogin === true" class="nav-item">
              <div class="nav-link active" aria-current="page">
                <router-link to="/" style="color: whitesmoke; text-decoration: none">{{user.role === 'USER'? '個人頁' : '管理頁'}}</router-link>
              </div>
            </li>
            <li class="nav-item">
        ...
        <a class="btn btn-outline-primary mr-2" v-if="isLogin === false" href="/login">登入</a>
        <a class="btn btn-outline-primary mr-2"  href="/signup">註冊</a>
